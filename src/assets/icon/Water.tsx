...
const Water: React.FC<React.SVGProps<SVGSVGElement>> = ({ color }) => (
  <svg width="23" height="17" viewBox="0 0 23 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect
      ...
      fill={color}
    />
    <circle cx="5.76761" cy="6.21954" r="4.26859" stroke="#34C184" strokeWidth="2" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
    ...
    <defs>
      ...
      >
        <stop stopColor="#8FD35E" />
        <stop offset="1" stopColor="#B9DAA1" />
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#B9DAA1" />
        <stop offset="1" stopColor="#8DD35A" />
      </linearGradient>
    </defs>
  </svg>
);
